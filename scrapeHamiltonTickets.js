...
export async function areStandingTicketsAvailable() {
  console.log('Hamilton ticket scraper started');
  ...
  await browser.close();
  console.log('Hamilton ticket scraper finished');
  return todayCheapestTickets.length > 0 ? Math.min(...todayCheapestTickets) < 20 : false;
}